...
class HashCommon
{
    ...
    final static float DEFAULT_LOAD_FACTOR = .75f;
    /** The load factor for a (usually small) table that is meant to be particularly fast. */
    final static float FAST_LOAD_FACTOR = .5f;
    /** The load factor for a (usually very small) table that is meant to be extremely fast. */
    final static float VERY_FAST_LOAD_FACTOR = .25f;
     ...
     *
     * <p>
     * This method implements the finalisation step of Austin Appleby's <a href="http://code.google.com/p/smhasher/">MurmurHash3</a>.
